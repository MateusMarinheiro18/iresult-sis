...
import type { CalendarEvent } from '@/components/client/calendar/calendarTypes';
import CalendarHeader from '@/components/client/calendar/CalendarHeader';
import MonthGrid from '@/components/client/calendar/MonthGrid';
import EventListPanel from '@/components/client/calendar/EventListPanel';

// IMPORTA OS ESTILOS DO CALENDÁRIO (coloque o mesmo CSS na pasta client)
import './calendar.css';
  ...
  useEffect(() => {
    async function fetchEvents() {
      try {
        ...
        // === ROUTE ADAPTADA PARA CLIENT ===
        const res = await fetch('/api/client/calendario/itens');
        if (!res.ok) {
