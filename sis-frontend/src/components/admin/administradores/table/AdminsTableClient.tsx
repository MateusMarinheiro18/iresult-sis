...
export default function AdminsTableClient({
  initialData,
}: {
  initialData: Admin[];
}) {
  ...
  function goToCreate() {
    router.push(`/admin/administradores/new`);
  }

  return (
    <div className="wrapper">
      <div className="controls-row">
        <div className="search-box" role="search" aria-label="Buscar administrador por nome ou email">
          ...
          <input
            ...
            aria-label="Buscar administradores por nome ou email"
          />
        </div>
        ...
        <div className="right-actions">
          <button
            className="btn-new"
            onClick={goToCreate}
            aria-label="Criar novo administrador"
        ...
        <table className="companies-table" cellPadding={0} cellSpacing={0}>
          <thead>
            <tr>
              ...
              <th className="col-created">Email</th>
          ...
          <tbody>
            ...
            {currentItems.length === 0 && (
              <tr>
                <td colSpan={4} className="no-results">Nenhum administrador encontrado.</td>
              </tr>
            )}
          </tbody>
        </table>
      ...
      {totalItems > 0 && (
        <div className="pagination-wrapper">
          <div className="pagination-info">
            Mostrando {startIndex + 1}-{Math.min(endIndex, totalItems)} de {totalItems} {totalItems === 1 ? 'administrador' : 'administradores'}
          </div>
      ...
      <style jsx>{`
        /* Reaproveitei exatamente os estilos do seu componente UsersRhTableClient */
