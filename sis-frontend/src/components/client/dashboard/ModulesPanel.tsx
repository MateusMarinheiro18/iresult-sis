...
type Modulo = { id: number; nome: string; media: number; classificacao: string };
type Categoria = { id: number; nome: string; media: number; classificacao: string };
...
export default function ModulesPanelClient({
  modulos, moduloSelecionado, categorias, loadingCategorias, onSelectModulo, onClearModulo
}: {
  modulos: Modulo[]; moduloSelecionado: number | null; categorias: Categoria[]; loadingCategorias: boolean;
  onSelectModulo: (id: number) => void; onClearModulo: () => void;
}) {
